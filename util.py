...
def curve(mapping: Callable[[float], float], offset: float, deadband: float, max_mag: float) -> Callable[[float], float]:
...
def linear_curve(scalar: float = 1.0, offset: float = 0.0, deadband: float = 0.0, max_mag: float = 0.0) -> Callable[[float], float]:
    return curve(lambda x : scalar*x, offset, deadband, max_mag)

def ollie_curve(scalar: float = 1.0, offset: float = 0.0, deadband: float = 0.0, max_mag: float = 0.0) -> Callable[[float], float]:
    return curve(lambda x : scalar*x*abs(x), offset, deadband, max_mag)

def cubic_curve(scalar: float = 1.0, offset: float = 0.0, deadband: float = 0.0, max_mag: float = 0.0) -> Callable[[float], float]:
